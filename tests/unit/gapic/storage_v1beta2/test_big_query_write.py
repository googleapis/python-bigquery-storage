...
from google.cloud.bigquery.storage_v1beta2.services.big_query_write import (
    BigQueryWriteAsyncClient,
)
from google.cloud.bigquery.storage_v1beta2.services.big_query_write import (
    BigQueryWriteClient,
)
from google.cloud.bigquery.storage_v1beta2.services.big_query_write import transports
...
def test_big_query_write_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigquery.storage_v1beta2.services.big_query_write.transports.BigQueryWriteGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_append_rows_flattened():
    ...
    with mock.patch.object(type(client.transport.append_rows), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.append_rows(write_stream="write_stream_value",)
...
def test_append_rows_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.append_rows(
            storage.AppendRowsRequest(), write_stream="write_stream_value",
        )
...
async def test_append_rows_flattened_async():
    ...
    with mock.patch.object(type(client.transport.append_rows), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.append_rows(write_stream="write_stream_value",)
...
def test_big_query_write_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigquery.storage_v1beta2.services.big_query_write.transports.BigQueryWriteTransport.__init__"
    ) as Transport:
...
def test_big_query_write_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.bigquery.storage_v1beta2.services.big_query_write.transports.BigQueryWriteTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
