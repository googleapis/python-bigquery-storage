...
from google.cloud.bigquery.storage_v1beta2.services.big_query_read import (
    BigQueryReadAsyncClient,
)
from google.cloud.bigquery.storage_v1beta2.services.big_query_read import (
    BigQueryReadClient,
)
from google.cloud.bigquery.storage_v1beta2.services.big_query_read import transports
...
def test_big_query_read_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.bigquery.storage_v1beta2.services.big_query_read.transports.BigQueryReadGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_big_query_read_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigquery.storage_v1beta2.services.big_query_read.transports.BigQueryReadTransport.__init__"
    ) as Transport:
...
def test_big_query_read_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.bigquery.storage_v1beta2.services.big_query_read.transports.BigQueryReadTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
