...
- While logged into your GitHub account, navigate to the
  ``python-bigquery-storage`` `repo`_ on GitHub.

- Fork and clone the ``python-bigquery-storage`` repository to your GitHub account by
  clicking the "Fork" button.

- Clone your fork of ``python-bigquery-storage`` from your GitHub account to your local
  computer, substituting your account username and specifying the destination
  as ``hack-on-python-bigquery-storage``.  E.g.::

   $ cd ${HOME}
   $ git clone git@github.com:USERNAME/python-bigquery-storage.git hack-on-python-bigquery-storage
   $ cd hack-on-python-bigquery-storage
...
.. _repo: https://github.com/googleapis/python-bigquery-storage
