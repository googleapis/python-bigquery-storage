...
class BigQueryWriteClient(metaclass=BigQueryWriteClientMeta):
    ...
    def _get_api_endpoint(api_override, client_cert_source, universe_domain, use_mtls_endpoint):
        ...
        if api_override is not None:
            ...
            api_endpoint = BigQueryWriteClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=universe_domain)
        return api_endpoint
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            BigQueryWriteClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, BigQueryWriteTransport, Callable[..., BigQueryWriteTransport]]] = None,
        ...
        self._use_client_cert, self._use_mtls_endpoint, self._universe_domain_env = BigQueryWriteClient._read_environment_variables()
        self._client_cert_source = BigQueryWriteClient._get_client_cert_source(self._client_options.client_cert_source, self._use_client_cert)
        self._universe_domain = BigQueryWriteClient._get_universe_domain(universe_domain_opt, self._universe_domain_env)
        ...
        if not transport_provided:
            ...
            transport_init: Union[Type[BigQueryWriteTransport], Callable[..., BigQueryWriteTransport]] = (
    ...
    def create_write_stream(self,
        ...
        """
        warnings.warn("BigQueryWriteClient.create_write_stream is deprecated",
            DeprecationWarning)
    ...
    def append_rows(self,
        ...
        """
        warnings.warn("BigQueryWriteClient.append_rows is deprecated",
            DeprecationWarning)
    ...
    def get_write_stream(self,
        ...
        """
        warnings.warn("BigQueryWriteClient.get_write_stream is deprecated",
            DeprecationWarning)
    ...
    def finalize_write_stream(self,
        ...
        """
        warnings.warn("BigQueryWriteClient.finalize_write_stream is deprecated",
            DeprecationWarning)
    ...
    def batch_commit_write_streams(self,
        ...
        """
        warnings.warn("BigQueryWriteClient.batch_commit_write_streams is deprecated",
            DeprecationWarning)
    ...
    def flush_rows(self,
        ...
        """
        warnings.warn("BigQueryWriteClient.flush_rows is deprecated",
            DeprecationWarning)
