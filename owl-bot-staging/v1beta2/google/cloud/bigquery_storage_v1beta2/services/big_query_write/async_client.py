...
class BigQueryWriteAsyncClient:
    ...
    get_transport_class = functools.partial(type(BigQueryWriteClient).get_transport_class, type(BigQueryWriteClient))
    ...
    async def create_write_stream(self,
        ...
        """
        warnings.warn("BigQueryWriteAsyncClient.create_write_stream is deprecated",
            DeprecationWarning)
    ...
    def append_rows(self,
        ...
        """
        warnings.warn("BigQueryWriteAsyncClient.append_rows is deprecated",
            DeprecationWarning)
    ...
    async def get_write_stream(self,
        ...
        """
        warnings.warn("BigQueryWriteAsyncClient.get_write_stream is deprecated",
            DeprecationWarning)
    ...
    async def finalize_write_stream(self,
        ...
        """
        warnings.warn("BigQueryWriteAsyncClient.finalize_write_stream is deprecated",
            DeprecationWarning)
    ...
    async def batch_commit_write_streams(self,
        ...
        """
        warnings.warn("BigQueryWriteAsyncClient.batch_commit_write_streams is deprecated",
            DeprecationWarning)
    ...
    async def flush_rows(self,
        ...
        """
        warnings.warn("BigQueryWriteAsyncClient.flush_rows is deprecated",
            DeprecationWarning)
