...
from google.cloud.bigquery.storage_v1alpha.services.metastore_partition_service import MetastorePartitionServiceAsyncClient
from google.cloud.bigquery.storage_v1alpha.services.metastore_partition_service import MetastorePartitionServiceClient
from google.cloud.bigquery.storage_v1alpha.services.metastore_partition_service import transports
...
def test_metastore_partition_service_client_client_options_from_dict():
    with mock.patch('google.cloud.bigquery.storage_v1alpha.services.metastore_partition_service.transports.MetastorePartitionServiceGrpcTransport.__init__') as grpc_transport:
...
def test_metastore_partition_service_base_transport():
    ...
    with mock.patch('google.cloud.bigquery.storage_v1alpha.services.metastore_partition_service.transports.MetastorePartitionServiceTransport.__init__') as Transport:
...
def test_metastore_partition_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.bigquery.storage_v1alpha.services.metastore_partition_service.transports.MetastorePartitionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_metastore_partition_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.bigquery.storage_v1alpha.services.metastore_partition_service.transports.MetastorePartitionServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.MetastorePartitionServiceTransport()
        adc.assert_called_once()
