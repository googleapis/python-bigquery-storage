...
class CreateMetastorePartitionRequest(proto.Message):
    ...
    Attributes:
        ...
        metastore_partition (google.cloud.bigquery.storage_v1alpha.types.MetastorePartition):
...
class BatchCreateMetastorePartitionsRequest(proto.Message):
    ...
    Attributes:
        ...
        requests (MutableSequence[google.cloud.bigquery.storage_v1alpha.types.CreateMetastorePartitionRequest]):
...
class BatchCreateMetastorePartitionsResponse(proto.Message):
    ...
    Attributes:
        partitions (MutableSequence[google.cloud.bigquery.storage_v1alpha.types.MetastorePartition]):
...
class BatchDeleteMetastorePartitionsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            of
            projects/{project}/locations/{location}/datasets/{dataset}/tables/{table}.
        partition_values (MutableSequence[google.cloud.bigquery.storage_v1alpha.types.MetastorePartitionValues]):
...
class BatchUpdateMetastorePartitionsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            of
            projects/{project}/locations/{location}/datasets/{dataset}/tables/{table}.
        requests (MutableSequence[google.cloud.bigquery.storage_v1alpha.types.UpdateMetastorePartitionRequest]):
...
class ListMetastorePartitionsResponse(proto.Message):
    ...
    Attributes:
        partitions (google.cloud.bigquery.storage_v1alpha.types.MetastorePartitionList):
            The list of partitions.

            This field is a member of `oneof`_ ``response``.
        streams (google.cloud.bigquery.storage_v1alpha.types.StreamList):
            The list of streams.
...
class StreamMetastorePartitionsRequest(proto.Message):
    ...
    Attributes:
        parent (str):
            ...
            projects/{project}/locations/{location}/datasets/{dataset}/tables/{table}.
        metastore_partitions (MutableSequence[google.cloud.bigquery.storage_v1alpha.types.MetastorePartition]):
