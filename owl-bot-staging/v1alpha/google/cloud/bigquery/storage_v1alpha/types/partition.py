...
class StorageDescriptor(proto.Message):
    ...
    Attributes:
        ...
        output_format (str):
            ...
            The maximum length is 128 characters.
        serde_info (google.cloud.bigquery.storage_v1alpha.types.SerDeInfo):
...
class MetastorePartition(proto.Message):
    ...
    Attributes:
        ...
        create_time (google.protobuf.timestamp_pb2.Timestamp):
            ...
            partition.
        storage_descriptor (google.cloud.bigquery.storage_v1alpha.types.StorageDescriptor):
        ...
        parameters (MutableMapping[str, str]):
            ...
            KiB.
        fields (MutableSequence[google.cloud.bigquery.storage_v1alpha.types.FieldSchema]):
...
class StreamList(proto.Message):
    ...
    Attributes:
        streams (MutableSequence[google.cloud.bigquery.storage_v1alpha.types.ReadStream]):
