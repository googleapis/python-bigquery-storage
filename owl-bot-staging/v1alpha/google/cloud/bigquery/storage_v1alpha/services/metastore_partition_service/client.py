...
class MetastorePartitionServiceClient(metaclass=MetastorePartitionServiceClientMeta):
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (self._is_universe_domain_valid or
            MetastorePartitionServiceClient._compare_universes(self.universe_domain, self.transport._credentials))
    ...
    def batch_create_metastore_partitions(self,
        ...
        .. code-block:: python
            ...
            def sample_batch_create_metastore_partitions():
                # Create a client
                client = storage_v1alpha.MetastorePartitionServiceClient()
        ...
        Args:
            request (Union[google.cloud.bigquery.storage_v1alpha.types.BatchCreateMetastorePartitionsRequest, dict]):
    ...
    def batch_delete_metastore_partitions(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.storage_v1alpha.types.BatchDeleteMetastorePartitionsRequest, dict]):
                The request object. Request message for
    ...
    def batch_update_metastore_partitions(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.storage_v1alpha.types.BatchUpdateMetastorePartitionsRequest, dict]):
                The request object. Request message for
    ...
    def list_metastore_partitions(self,
        ...
        Args:
            request (Union[google.cloud.bigquery.storage_v1alpha.types.ListMetastorePartitionsRequest, dict]):
                The request object. Request message for
    ...
    def stream_metastore_partitions(self,
        ...
        Args:
            requests (Iterator[google.cloud.bigquery.storage_v1alpha.types.StreamMetastorePartitionsRequest]):
        ...
        Returns:
            Iterable[google.cloud.bigquery.storage_v1alpha.types.StreamMetastorePartitionsResponse]:
