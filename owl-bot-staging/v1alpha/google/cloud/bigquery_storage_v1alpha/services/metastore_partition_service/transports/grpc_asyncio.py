...
class MetastorePartitionServiceGrpcAsyncIOTransport(MetastorePartitionServiceTransport):
    ...
    def batch_create_metastore_partitions(self) -> Callable[
        ...
        if 'batch_create_metastore_partitions' not in self._stubs:
            self._stubs['batch_create_metastore_partitions'] = self.grpc_channel.unary_unary(
    ...
    def batch_delete_metastore_partitions(self) -> Callable[
        ...
        if 'batch_delete_metastore_partitions' not in self._stubs:
            self._stubs['batch_delete_metastore_partitions'] = self.grpc_channel.unary_unary(
    ...
    def batch_update_metastore_partitions(self) -> Callable[
        ...
        if 'batch_update_metastore_partitions' not in self._stubs:
            self._stubs['batch_update_metastore_partitions'] = self.grpc_channel.unary_unary(
    ...
    def stream_metastore_partitions(self) -> Callable[
        ...
        if 'stream_metastore_partitions' not in self._stubs:
            self._stubs['stream_metastore_partitions'] = self.grpc_channel.stream_stream(
