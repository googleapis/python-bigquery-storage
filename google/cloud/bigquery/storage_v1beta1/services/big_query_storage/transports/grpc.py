...
class BigQueryStorageGrpcTransport(BigQueryStorageTransport):
    ...
    def create_read_session(
        self,
    ) -> Callable[[storage.CreateReadSessionRequest], storage.ReadSession]:
    ...
    @property
    def finalize_stream(self) -> Callable[[storage.FinalizeStreamRequest], empty.Empty]:
...
__all__ = ("BigQueryStorageGrpcTransport",)
