...
class TableSchema(proto.Message):
    ...
    Attributes:
        fields (Sequence[google.cloud.bigquery.storage_v1beta2.types.TableFieldSchema]):
...
class TableFieldSchema(proto.Message):
    ...
    Attributes:
        name (str):
            ...
            characters.
        type_ (google.cloud.bigquery.storage_v1beta2.types.TableFieldSchema.Type):
            Required. The field data type.
        mode (google.cloud.bigquery.storage_v1beta2.types.TableFieldSchema.Mode):
