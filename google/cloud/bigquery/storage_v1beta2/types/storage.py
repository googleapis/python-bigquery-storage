...
from google.cloud.bigquery.storage_v1beta2.types import arrow
from google.cloud.bigquery.storage_v1beta2.types import avro
from google.cloud.bigquery.storage_v1beta2.types import protobuf
from google.cloud.bigquery.storage_v1beta2.types import stream
from google.cloud.bigquery.storage_v1beta2.types import table
...
class CreateReadSessionRequest(proto.Message):
    ...
    Attributes:
        ...
        read_session (google.cloud.bigquery.storage_v1beta2.types.ReadSession):
...
class StreamStats(proto.Message):
    ...
    Attributes:
        progress (google.cloud.bigquery.storage_v1beta2.types.StreamStats.Progress):
...
class ReadRowsResponse(proto.Message):
    ...
    Attributes:
        avro_rows (google.cloud.bigquery.storage_v1beta2.types.AvroRows):
            Serialized row data in AVRO format.
        arrow_record_batch (google.cloud.bigquery.storage_v1beta2.types.ArrowRecordBatch):
            Serialized row data in Arrow RecordBatch
            format.
        row_count (int):
            Number of serialized rows in the rows block.
        stats (google.cloud.bigquery.storage_v1beta2.types.StreamStats):
            Statistics for the stream.
        throttle_state (google.cloud.bigquery.storage_v1beta2.types.ThrottleState):
...
class SplitReadStreamResponse(proto.Message):
    ...
    Attributes:
        primary_stream (google.cloud.bigquery.storage_v1beta2.types.ReadStream):
            Primary stream, which contains the beginning portion of
            \|original_stream|. An empty value indicates that the
            original stream can no longer be split.
        remainder_stream (google.cloud.bigquery.storage_v1beta2.types.ReadStream):
...
class CreateWriteStreamRequest(proto.Message):
    ...
    Attributes:
        ...
        write_stream (google.cloud.bigquery.storage_v1beta2.types.WriteStream):
...
class AppendRowsRequest(proto.Message):
    ...
    Attributes:
        ...
        proto_rows (google.cloud.bigquery.storage_v1beta2.types.AppendRowsRequest.ProtoData):
    ...
    class ProtoData(proto.Message):
        ...
        Attributes:
            writer_schema (google.cloud.bigquery.storage_v1beta2.types.ProtoSchema):
                Proto schema used to serialize the data.
            rows (google.cloud.bigquery.storage_v1beta2.types.ProtoRows):
...
class AppendRowsResponse(proto.Message):
    ...
    Attributes:
        append_result (google.cloud.bigquery.storage_v1beta2.types.AppendRowsResponse.AppendResult):
        ...
        updated_schema (google.cloud.bigquery.storage_v1beta2.types.TableSchema):
    ...
    class AppendResult(proto.Message):
        ...
        offset = proto.Field(proto.MESSAGE, number=1, message=wrappers.Int64Value,)
...
class BatchCommitWriteStreamsResponse(proto.Message):
    ...
    Attributes:
        ...
        stream_errors (Sequence[google.cloud.bigquery.storage_v1beta2.types.StorageError]):
...
class StorageError(proto.Message):
    ...
    Attributes:
        code (google.cloud.bigquery.storage_v1beta2.types.StorageError.StorageErrorCode):
