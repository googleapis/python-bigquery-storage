...
from google.cloud.bigquery.storage_v1beta2.types import table as gcbs_table
...
class ReadSession(proto.Message):
    ...
    Attributes:
        ...
        data_format (google.cloud.bigquery.storage_v1beta2.types.DataFormat):
            Immutable. Data format of the output data.
        avro_schema (google.cloud.bigquery.storage_v1beta2.types.AvroSchema):
            Output only. Avro schema.
        arrow_schema (google.cloud.bigquery.storage_v1beta2.types.ArrowSchema):
            Output only. Arrow schema.
        table (str):
            Immutable. Table that this ReadSession is reading from, in
            the form
            \`projects/{project_id}/datasets/{dataset_id}/tables/{table_id}
        table_modifiers (google.cloud.bigquery.storage_v1beta2.types.ReadSession.TableModifiers):
            Optional. Any modifiers which are applied
            when reading from the specified table.
        read_options (google.cloud.bigquery.storage_v1beta2.types.ReadSession.TableReadOptions):
            Optional. Read options for this session (e.g.
            column selection, filters).
        streams (Sequence[google.cloud.bigquery.storage_v1beta2.types.ReadStream]):
    ...
    class TableReadOptions(proto.Message):
        ...
        Attributes:
            ...
            row_restriction (str):
                ...
                AND 5.0".
            arrow_serialization_options (google.cloud.bigquery.storage_v1beta2.types.ArrowSerializationOptions):
        ...
        arrow_serialization_options = proto.Field(
            proto.MESSAGE, number=3, message=arrow.ArrowSerializationOptions,
        )
...
class WriteStream(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.cloud.bigquery.storage_v1beta2.types.WriteStream.Type):
        ...
        table_schema (google.cloud.bigquery.storage_v1beta2.types.TableSchema):
