...
from google.cloud.bigquery.storage_v1beta2.types import storage
...
class BigQueryWriteAsyncClient:
    ...
    from_service_account_info = BigQueryWriteClient.from_service_account_info
    from_service_account_file = BigQueryWriteClient.from_service_account_file
    ...
    async def create_write_stream(
        ...
        *,
        ...
        Args:
            request (:class:`google.cloud.bigquery.storage_v1beta2.types.CreateWriteStreamRequest`):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            write_stream (:class:`google.cloud.bigquery.storage_v1beta2.types.WriteStream`):
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta2.types.WriteStream:
    ...
    def append_rows(
        ...
        *,
        ...
        Args:
            requests (AsyncIterator[`google.cloud.bigquery.storage_v1beta2.types.AppendRowsRequest`]):
        ...
        Returns:
            AsyncIterable[google.cloud.bigquery.storage_v1beta2.types.AppendRowsResponse]:
    ...
    async def get_write_stream(
        ...
        *,
        ...
        Args:
            request (:class:`google.cloud.bigquery.storage_v1beta2.types.GetWriteStreamRequest`):
                The request object. Request message for
    ...
    async def finalize_write_stream(
        ...
        *,
        ...
        Args:
            request (:class:`google.cloud.bigquery.storage_v1beta2.types.FinalizeWriteStreamRequest`):
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta2.types.FinalizeWriteStreamResponse:
    ...
    async def batch_commit_write_streams(
        ...
        *,
        ...
        Args:
            request (:class:`google.cloud.bigquery.storage_v1beta2.types.BatchCommitWriteStreamsRequest`):
                The request object. Request message for
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta2.types.BatchCommitWriteStreamsResponse:
    ...
    async def flush_rows(
        ...
        *,
        ...
        Args:
            request (:class:`google.cloud.bigquery.storage_v1beta2.types.FlushRowsRequest`):
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta2.types.FlushRowsResponse:
