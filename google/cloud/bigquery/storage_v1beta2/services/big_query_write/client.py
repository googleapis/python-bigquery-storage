...
class BigQueryWriteClient(metaclass=BigQueryWriteClientMeta):
    ...
    def create_write_stream(
        ...
        *,
        ...
        Args:
            request (google.cloud.bigquery.storage_v1beta2.types.CreateWriteStreamRequest):
    ...
    def append_rows(
        ...
        *,
        ...
        Args:
            requests (Iterator[google.cloud.bigquery.storage_v1beta2.types.AppendRowsRequest]):
        ...
        Returns:
            Iterable[google.cloud.bigquery.storage_v1beta2.types.AppendRowsResponse]:
    ...
    def get_write_stream(
        ...
        *,
        ...
        Args:
            request (google.cloud.bigquery.storage_v1beta2.types.GetWriteStreamRequest):
                The request object. Request message for
    ...
    def finalize_write_stream(
        ...
        *,
        ...
        Args:
            request (google.cloud.bigquery.storage_v1beta2.types.FinalizeWriteStreamRequest):
    ...
    def batch_commit_write_streams(
        ...
        *,
        ...
        Args:
            request (google.cloud.bigquery.storage_v1beta2.types.BatchCommitWriteStreamsRequest):
                The request object. Request message for
    ...
    def flush_rows(
        ...
        *,
        ...
        Args:
            request (google.cloud.bigquery.storage_v1beta2.types.FlushRowsRequest):
