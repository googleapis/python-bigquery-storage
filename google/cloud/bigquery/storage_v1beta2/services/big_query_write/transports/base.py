...
class BigQueryWriteTransport(abc.ABC):
    ...
    def create_write_stream(
        ...
        typing.Union[stream.WriteStream, typing.Awaitable[stream.WriteStream]],
    ]:
    ...
    def append_rows(
        ...
        typing.Union[
            storage.AppendRowsResponse, typing.Awaitable[storage.AppendRowsResponse]
        ],
    ]:
        raise NotImplementedError()
    ...
    def flush_rows(
        ...
        typing.Union[
            storage.FlushRowsResponse, typing.Awaitable[storage.FlushRowsResponse]
        ],
    ]:
        raise NotImplementedError()
