...
class BigQueryReadClient(metaclass=BigQueryReadClientMeta):
    ...
    def create_read_session(
        ...
        *,
        ...
        Args:
            request (google.cloud.bigquery.storage_v1beta2.types.CreateReadSessionRequest):
    ...
    def read_rows(
        ...
        *,
        ...
        Args:
            request (google.cloud.bigquery.storage_v1beta2.types.ReadRowsRequest):
        ...
        Returns:
            Iterable[google.cloud.bigquery.storage_v1beta2.types.ReadRowsResponse]:
    ...
    def split_read_stream(
        ...
        *,
        ...
        Args:
            request (google.cloud.bigquery.storage_v1beta2.types.SplitReadStreamRequest):
                The request object. Request message for
                `SplitReadStream`.
