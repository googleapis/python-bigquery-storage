...
class BigQueryReadAsyncClient:
    ...
    async def create_read_session(
        ...
        *,
        ...
        Args:
            request (:class:`google.cloud.bigquery.storage_v1beta2.types.CreateReadSessionRequest`):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            read_session (:class:`google.cloud.bigquery.storage_v1beta2.types.ReadSession`):
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta2.types.ReadSession:
    ...
    def read_rows(
        ...
        *,
        ...
        Args:
            request (:class:`google.cloud.bigquery.storage_v1beta2.types.ReadRowsRequest`):
        ...
        Returns:
            AsyncIterable[google.cloud.bigquery.storage_v1beta2.types.ReadRowsResponse]:
    ...
    async def split_read_stream(
        ...
        *,
        ...
        Args:
            request (:class:`google.cloud.bigquery.storage_v1beta2.types.SplitReadStreamRequest`):
                The request object. Request message for
                `SplitReadStream`.
        ...
        Returns:
            google.cloud.bigquery.storage_v1beta2.types.SplitReadStreamResponse:
